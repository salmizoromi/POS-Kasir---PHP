...
<div class="col-sm-3">
     <div class="card card-primary">
       ...
       <div class="card-body">
         <img src="assets/img/user/<?php echo htmlspecialchars($hasil['gambar']); ?>" alt="#" class="img-fluid w-100" />
       </div>
       <div class="card-footer">
         <form method="POST" action="fungsi/edit/edit.php" enctype="multipart/form-data">
